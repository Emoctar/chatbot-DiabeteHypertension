...
SECRET_KEY = 'django-insecure-4s1c)&#0*c))(gg=s@sbe7_rixz)_qp62xhdd88quv5l(8uos='
...
# Dossiers où Django recherchera les fichiers statiques
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
